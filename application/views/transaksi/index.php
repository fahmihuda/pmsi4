	...
	<div class="">
		...
		<div class="card-body p-4">
						...
						<div class="modal-content">
						  ...
						  <div class="modal-body">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<label for="biaya_tambahan_transaksi">Biaya Tambahan (Rp.)</label>
										<input type="text" name="biaya_tambahan" id="biaya_tambahan_transaksi" class="form-control" value="<?= set_value('biaya_tambahan'); ?>">
			...
			<div class="row justify-content-center text-center my-2">
				...
				<div class="col-md m-1 px-0">
					<a href="<?= base_url('transaksi/index/' . 'siap diambil'); ?>" class="btn btn-info">Siap diambil/Antar</a> <span class="badge badge-info"><?= $jumlah_status_transaksi_siap_diambil['siap diambil']; ?></span>
				</div>
				<div class="col-md m-1 px-0">
					<a href="<?= base_url('transaksi/index/' . 'sudah diambil'); ?>" class="btn btn-success">Sudah diambil/Antar</a> <span class="badge badge-success"><?= $jumlah_status_transaksi_sudah_diambil['sudah diambil']; ?></span>
				</div>
			</div>
										...
										<tr>
											...
											<td>
											  ...
											  <?php elseif ($dt['status_transaksi'] == 'siap diambil'): 
													$dt['status_transaksi'] = $dt['status_transaksi'] . '/Diantar';
												?>
